      ...
      {data.map((item) => (
        <div key={item.title}>
          ...
          <div
            ...
            className={`w-56 h-40 sm:w-80 sm:h-60 lg:w-[26rem] lg:h-72 hover:scale-125  transition-all duration-300 bg-cover bg-center 5 flex justify-center items-center text-center p-8 relative`}
          >
